...
const nextConfig = {
   ...
   */
  basePath: process.env.NODE_ENV === 'production' ? '/04-zkapp-brower-ui' : '', // update if your repo name changes for 'npm run deploy' to work successfully
  assetPrefix: process.env.NODE_ENV === 'production' ? '/04-zkapp-brower-ui/' : '', // update if your repo name changes for 'npm run deploy' to work successfully
};
